var option = {};
option.url = {
	'api_admin' : '/facebook_p2p_action/admin/',
	'api_account' : '/facebook_p2p_action/account/',
	'api_user' : '/facebook_p2p_action/user/',
	'api_accountrecord' : '/facebook_p2p_action/accountrecord/',
	'api_product' : '/facebook_p2p_action/product/',
	'api_creditor' : '/facebook_p2p_action/creditor/',
	'api_match' : '/facebook_p2p_action/matchManagement/',
	'api_message' : '/facebook_p2p_action/',
	'api_UsersFunds' : '/facebook_p2p_action/UsersFunds/'
};
option.header = {
	'headers' : {
					...
					return {
						signIn : function($str) {
							...
							return $http.post(option.url.api_account + 'login',
									$str, option.header);
							// facebook_p2p_action/account/login
						}
					}
				})
				...
				function($http) {
					return {
						...
						getProductById : function($str) {
							...
							// /facebook_p2p_action/product/findProductById
						},
						// 根据产品来获取利率信息
				...
				function($http) {
					return {
			            ...
			            selectWaitMoney : function($str) {
							return $http
									.post(
											"/facebook_p2p_action/accountLog/selectWaitMoney",
											$str, option.header)
						},
						// 开始匹配
						startMatchByManually : function($str) {
							return $http
									.post(
											'/facebook_p2p_action/match/startMatchByManually',
											$str, option.header);
						}
					}
				})
