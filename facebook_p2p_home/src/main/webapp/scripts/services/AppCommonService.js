var option = {
    'url':{
        'api_user':'/facebook_p2p_action/user/', //用户相关
        'api_investment':'/facebook_p2p_action/investment/', 
        'api_productRate':'/facebook_p2p_action/productRate/',
        'api_product':'/facebook_p2p_action/product/', 
        'api_productAccount':'/facebook_p2p_action/productaccount/',
        'api_acount':'/facebook_p2p_action/account/',
        'api_verification':'/facebook_p2p_action/verification/',
        'api_emailAuth':'/facebook_p2p_action/emailAuth/',
        'api_paymentpwd':'/facebook_p2p_action/paymentpwd/',
        'api_extracts':'/facebook_p2p_action/extracts/',  //提现与支付功能
        'api_bankcardInfo':'/facebook_p2p_action/bankCardInfo/',
        'api_charges':'/facebook_p2p_action/charges/'
    },
    'header':{
        'headers':{
        ...
        return {
           ...
           //注册校验验证码的正确性
            ...
            checkPhoneCode:function($str){
                ...
                // /facebook_p2p_action/verification/validateSMS
            },
            ...
            getUserSafeInfo:function($str){
                ...
                // /facebook_p2p_action/user/userSecureDetailed
            },
            ...
            getAbleAccout:function(){
                ...
                // /facebook_p2p_extracts/extractMoney
            },
            ...
            withdraw:function($str){
                ...
                // /facebook_p2p_action/charges/addMayTake
            },
            ...
            logout:function($str){
                ...
                //  //facebook_p2p_action/user/logout
            },
    ...
    .factory('UserService',function ($http,AuthService) {
        return {
            ...
            signIn: function($str) {
                ...
                // //facebook_p2p_action/user/login
            },
            ...
            register: function($str) {
                ...
                // //facebook_p2p_action/user/signup
            },
